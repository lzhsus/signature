...
export default (headimgurl, cb)=>{
    ...
    let imgArr = [
        appConfig.serverPath+'weapp/static/generateposter/img-01.jpg',
        appConfig.serverPath+'weapp/static/generateposter/img-02.jpg',
        appConfig.serverPath+'weapp/static/generateposter/img-03.jpg',
        appConfig.serverPath+'weapp/static/generateposter/img-04.jpg'
    ]
